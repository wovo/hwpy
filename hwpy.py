...
class mpu6050:
    ...
    def gyroscopes(self):
        ...
        return (
            self.registers.read_word(self.GYRO_XOUT0),
            self.registers.read_word(self.GYRO_YOUT0),
            self.registers.read_word(self.GYRO_ZOUT0))
    ...
    def acceleration(self):
        ...
        return (
            self.registers.read_word(self.ACCEL_XOUT0),
            self.registers.read_word(self.ACCEL_YOUT0),
            self.registers.read_word(self.ACCEL_ZOUT0))
    ...
    def write_char(self, char):
        ...
        if char == '\n':
            ...
            self.goto_state = 1
                ...
                (self.position.x >= 0)
                and (self.position.x < self.size.x)
                and (self.position.y >= 0)
                and (self.position.y < self.size.y)
        ):

            # handle the gap for 1-line displays
            if ((self.size.x == 1) and (self.position.x == 8)):
                self.cursor(self.position)
